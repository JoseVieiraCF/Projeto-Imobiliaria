        ...
        <article class="dash_login_left_box">
            ...
            <form name="login" action="{{route('admin.login.do')}}" method="post" autocomplete="off">
                <label>
                    ...
                    <input type="email" name="email" placeholder="Informe seu e-mail" value="josevieira8161@gmail.com" required/>
                </label>
            ...
            <footer>
                <p>Desenvolvido por <a href="https://github.com/JoseVieiraCF">José Vieira</a></p>
